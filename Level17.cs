...
{
    public partial class Level17 : Form
    {
        ...
        private void TimerWalk_Tick(object sender, EventArgs e)
        {
            ...
            {
                if (x is PictureBox && x.Tag == "Console")
                {
                    if (player.Bounds.IntersectsWith(x.Bounds))
                    {
                        player.Top += 100;
                        this.Controls.Remove(x);
                        CodeLine CMD = new CodeLine();
                        CMD.Show();
                        goup = false;
                        godown = false;
                        goright = false;
                ...
                if (player.Left >= 772)
                    Boss.Image = Properties.Resources.Skeleton;
