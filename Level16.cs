...
{
    public partial class Level16 : Form
    {
        ...
        private void TimerWalk_Tick(object sender, EventArgs e)
        {
            ...
            try{
                progressBar1.Value = DragonHeal;
            }
            catch { progressBar1.Value = 0; }
            ...
            foreach (Control x in this.Controls)
            {
                ...
                if (x is PictureBox && x.Tag == "Dragon")
                {
                    if (player.Bounds.IntersectsWith(x.Bounds))
                    {
                        if (attack == true)
                    ...
                    if (DragonHeal < 0)
                    {
                        Dragon.Image = Properties.Resources.Dragon3;
                        this.Controls.Remove(BreakWall);
                        DragonTimer.Stop();
                    }
        ...
        private void MagicBallWalk_Tick(object sender, EventArgs e)
        {
            ...
            foreach (Control x in this.Controls)
            {
                if (x is PictureBox && x.Tag == "DragonBall")
                {
                    x.Top += 4;
                        if (x.Bounds.IntersectsWith(player.Bounds))
                        {
                            this.Controls.Remove(x);
                            damage = 75 - (playerProtection / 2);
                            if (damage > 0)
                            {
                                playerHeal -= damage;
                                HitplayerZobrazeni.Text = "-" + Convert.ToString(damage);
                        ...
                        if (x.Bounds.IntersectsWith(pictureBox10.Bounds))
                        {
                            this.Controls.Remove(x);
                        }
                }
        ...
        private void DragonTimer_Tick(object sender, EventArgs e)
        {
            ...
            if (player.Bounds.IntersectsWith(Dragon.Bounds))
            {
                player.Top = Dragon.Top + Dragon.Height + 50;
                playerHeal -= 30;
            }
            int Event = Rand.Next(1, 7);
            if (Event <= 2)
                for (int i = 0; i < 10; i++)
                {
                    Dragon.Image = Properties.Resources.Dragon2;
                    AnimateTimer.Start();
                    DBX = Rand.Next(500, 1556);
                    PictureBox Dball = new PictureBox
                    {
                        Name = "pictureBox",
                        Size = new Size(50, 50),
                        Location = new Point(DBX, 366),
                        Image = Properties.Resources.fireball1,
                        Tag = "DragonBall",
                        BackColor = System.Drawing.Color.Transparent,
                    };
                    this.Controls.Add(Dball);
                    Dball.BringToFront();
                }
            if (Event == 3)
                for (int i = 0; i < 5; i++)
            ...
            {
                int DBY;
                DBY = Rand.Next(335, 677);
                DBX = Rand.Next(500, 1556);
                PictureBox item = new PictureBox
                {
                    Name = "pictureBox",
                    Size = new Size(40, 40),
                    Location = new Point(DBX, DBY),
                ...
                DBY = Rand.Next(335, 677);
                DBX = Rand.Next(500, 1556);
                PictureBox item2 = new PictureBox
                {
                    Name = "pictureBox",
                    Size = new Size(40, 40),
                    Location = new Point(DBX, DBY),
        ...
        {
            Dragon.Image = Properties.Resources.Dragon;
            AnimateTimer.Stop();
        }
    }    
}
