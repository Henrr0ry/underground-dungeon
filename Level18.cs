...
{
    public partial class Level18 : Form
    {
        ...
        private void Level1_SizeChanged(object sender, EventArgs e)
        {
            ...
            Floorbox.Top = this.Height - 60 - Floorbox.Height - poleinventory.Height;
            FloorLab.Top = this.Height - 70 - FloorLab.Height - poleinventory.Height;
        }
        ...
        private void Level1_Load(object sender, EventArgs e)
        {
            ...
            if (MainSetting.Default.SavingUser == 1 && UserSaveSlot.Default.Sex1 == "Female")
                SexMale = false;
            if (MainSetting.Default.SavingUser == 2 && UserSaveSlot.Default.Sex2 == "Female")
                SexMale = false;
            if (MainSetting.Default.SavingUser == 3 && UserSaveSlot.Default.Sex3 == "Female")
                SexMale = false;
        }
        ...
        private void TimerWalk_Tick(object sender, EventArgs e)
        {
            ...
            foreach (Control x in this.Controls)
            {
                ...
                {
                    floor++;
                    FloorLab.Text = "Level - " + floor;
                    player.Top = 131; 
                    player.Left = 167;
                    foreach(Control y in this.Controls)
                    {
                        if (y is PictureBox && y.Tag == "armor1" || y.Tag == "armor2" || y.Tag == "armor3" || y.Tag == "sword1" || y.Tag == "sword2" || y.Tag == "sword3" 
                            || y.Tag == "fireball1" || y.Tag == "fireball2" || y.Tag == "fireball3" || y.Tag == "potionHeal"|| y.Tag == "potionXP" || y.Tag == "potionBoost"
                                || y.Tag == "Rat" || y.Tag == "Enemy" || y.Tag == "Wither" || y.Tag == "enemyKing" || y.Tag == "skeleton" || y.Tag == "barrel" || y.Tag == "coin"
                                || y.Tag == "Trader" || y.Tag == "opened" || y.Tag == "chest" || y.Tag == "chestGold"|| y.Tag == "torch")
                            this.Controls.Remove(y);
                    }
                        PictureBox armor1 = new PictureBox
                        {
                            Name = "pictureBox",
                            Size = new Size(40, 40),
                            Location = new Point(GeX, GeY),
                            BackgroundImage = Properties.Resources.Chestplate1slot,
                            BackgroundImageLayout = ImageLayout.Stretch,
                            Tag = "armor1",
                            BackColor = System.Drawing.Color.Transparent,
                        };
                        PictureBox armor2 = new PictureBox
                        {
                            Name = "pictureBox",
                            Size = new Size(40, 40),
                            Location = new Point(GeX, GeY),
                            BackgroundImage = Properties.Resources.Chestplate2slot,
                            BackgroundImageLayout = ImageLayout.Stretch,
                            Tag = "armor2",
                            BackColor = System.Drawing.Color.Transparent,
                        };
                        PictureBox armor3 = new PictureBox
                        {
                            Name = "pictureBox",
                            Size = new Size(40, 40),
                            Location = new Point(GeX, GeY),
                            BackgroundImage = Properties.Resources.Chestplate3slot,
                            BackgroundImageLayout = ImageLayout.Stretch,
                            Tag = "armor3",
                            BackColor = System.Drawing.Color.Transparent,
                        };
                        PictureBox sword1 = new PictureBox
                        {
                            Name = "pictureBox",
                            Size = new Size(40, 40),
                            Location = new Point(GeX, GeY),
                            BackgroundImage = Properties.Resources.sword1Slot,
                            BackgroundImageLayout = ImageLayout.Stretch,
                            Tag = "sword1",
                            BackColor = System.Drawing.Color.Transparent,
                        };
                        PictureBox sword2 = new PictureBox
                        {
                            Name = "pictureBox",
                            Size = new Size(40, 40),
                            Location = new Point(GeX, GeY),
                            BackgroundImage = Properties.Resources.sword2Slot,
                            BackgroundImageLayout = ImageLayout.Stretch,
                            Tag = "sword2",
                            BackColor = System.Drawing.Color.Transparent,
                        };
                        PictureBox sword3 = new PictureBox
                        {
                            Name = "pictureBox",
                            Size = new Size(40, 40),
                            Location = new Point(GeX, GeY),
                            BackgroundImage = Properties.Resources.sword3Slot,
                            BackgroundImageLayout = ImageLayout.Stretch,
                            Tag = "sword3",
                            BackColor = System.Drawing.Color.Transparent,
                        };
                        PictureBox fireball1 = new PictureBox
                        {
                            Name = "pictureBox",
                            Size = new Size(40, 40),
                            Location = new Point(GeX, GeY),
                            BackgroundImage = Properties.Resources.fireball1Slot,
                            Tag = "fireball1",
                            BackgroundImageLayout = ImageLayout.Stretch,
                            BackColor = System.Drawing.Color.Transparent,
                        };
                        PictureBox fireball2 = new PictureBox
                        {
                            ...
                            Size = new Size(40, 40),
                            Location = new Point(GeX, GeY),
                            BackgroundImage = Properties.Resources.MagicShootSlot,
                            Tag = "fireball2",
                            BackgroundImageLayout = ImageLayout.Stretch,
                            BackColor = System.Drawing.Color.Transparent,
                        };
                        PictureBox fireball3 = new PictureBox
                        {
                            ...
                            Size = new Size(40, 40),
                            Location = new Point(GeX, GeY),
                            BackgroundImage = Properties.Resources.energyElipse1Slot,
                            BackgroundImageLayout = ImageLayout.Stretch,
                            Tag = "fireball3",
                            BackColor = System.Drawing.Color.Transparent,
                        };
                        PictureBox potionXP = new PictureBox
                        {
                            Name = "pictureBox",
                            Size = new Size(40, 40),
                            Location = new Point(GeX, GeY),
                            BackgroundImage = Properties.Resources.potionXP,
                            Tag = "potionXp",
                            BackColor = System.Drawing.Color.Transparent,
                        };
                        PictureBox potionBoost = new PictureBox
                        {
                            Name = "pictureBox",
                            Size = new Size(40, 40),
                            Location = new Point(GeX, GeY),
                            BackgroundImage = Properties.Resources.potionboost,
                            Tag = "potionBoost",
                            BackColor = System.Drawing.Color.Transparent,
                        };
                        PictureBox potionHeal = new PictureBox
                        {
                            Name = "pictureBox",
                            Size = new Size(40, 40),
                            Location = new Point(GeX, GeY),
                            BackgroundImage = Properties.Resources.potionheal,
                            Tag = "potionHeal",
                            BackColor = System.Drawing.Color.Transparent,
                        };
                        PictureBox Rat = new PictureBox
                        {
                            ...
                            Size = new Size(75, 55),
                            Location = new Point(GeX, GeY),
                            BackgroundImage = Properties.Resources.enemyRat,
                            Tag = "enemyRat",
                            BackColor = System.Drawing.Color.Transparent,
                        };
                        PictureBox Enemy = new PictureBox
                        {
                            ...
                            Size = new Size(50, 55),
                            Location = new Point(GeX, GeY),
                            BackgroundImage = Properties.Resources.enemyWarrior,
                            Tag = "enemy",
                            BackColor = System.Drawing.Color.Transparent,
                        };
                        PictureBox Wither = new PictureBox
                        {
                            Name = "pictureBox",
                            Size = new Size(50, 55),
                            Location = new Point(GeX, GeY),
                            BackgroundImage = Properties.Resources.enemyWither,
                            Tag = "enemyWither",
                            BackColor = System.Drawing.Color.Transparent,
                        };
                        PictureBox enemyKing = new PictureBox
                        {
                            Name = "pictureBox",
                            Size = new Size(100, 110),
                            Location = new Point(GeX, GeY),
                            BackgroundImage = Properties.Resources.enemyKing,
                            Tag = "enemyKing",
                            BackColor = System.Drawing.Color.Transparent,
                        };
                        PictureBox chest = new PictureBox
                        {
                            ...
                            Size = new Size(50, 55),
                            Location = new Point(GeX, GeY),
                            BackgroundImage = Properties.Resources.chest,
                            Tag = "chest",
                            BackColor = System.Drawing.Color.Transparent,
                        };
                        PictureBox chestGold = new PictureBox
                        {
                            Name = "pictureBox",
                            Size = new Size(50, 55),
                            Location = new Point(GeX, GeY),
                            BackgroundImage = Properties.Resources.chestGold,
                            Tag = "chestGold",
                            BackColor = System.Drawing.Color.Transparent,
                        };
                        ...
                        PictureBox torch = new PictureBox
                        {
                            Name = "pictureBox",
                            Size = new Size(50, 55),
                            Location = new Point(GeX, GeY),
                            BackgroundImage = Properties.Resources.torch0,
                            BackColor = System.Drawing.Color.Transparent,
                            Tag = "torch",
                        };
                        PictureBox skeleton = new PictureBox
                        {
                            ...
                            Size = new Size(50, 55),
                            Location = new Point(GeX, GeY),
                            BackgroundImage = Properties.Resources.Skeleton,
                            BackColor = System.Drawing.Color.Transparent,
                            Tag = "skeleton",
                        };
                        PictureBox barrel = new PictureBox
                        {
                            ...
                            Location = new Point(GeX, GeY),
                            BackgroundImage = Properties.Resources.Barrel,
                            BackColor = System.Drawing.Color.Transparent,
                            Tag = "barrel",
                        };
                        PictureBox Trader = new PictureBox
                        {
                            Name = "pictureBox",
                            Size = new Size(50, 55),
                            Location = new Point(GeX, GeY),
                            BackgroundImage = Properties.Resources.trader,
                            Tag = "Trader",
                            BackColor = System.Drawing.Color.Transparent,
                        };
                    //generate
                    Generate = Rand.Next(0, 2);
                    NumItem = Rand.Next(1, 3);
                    if (Generate == 1)
                    {
                        GeX = Rand.Next(167, 1622);
                        GeY = Rand.Next(131, 649);
                        armor1.Location = new Point(GeX, GeY);
                        armor2.Location = new Point(GeX, GeY);
                        armor3.Location = new Point(GeX, GeY);
                        if (NumItem == 1)
                            this.Controls.Add(armor1);
                        if (NumItem == 2)
                            this.Controls.Add(armor2);
                        if (NumItem == 3)
                            this.Controls.Add(armor3);
                    }
                    Generate = Rand.Next(0, 2);
                    NumItem = Rand.Next(1, 3);
                    if (Generate == 1)
                    {
                        GeX = Rand.Next(167, 1622);
                        GeY = Rand.Next(131, 649);
                        potionHeal.Location = new Point(GeX, GeY);
                        potionXP.Location = new Point(GeX, GeY);
                        potionBoost.Location = new Point(GeX, GeY);
                        if (NumItem == 1)
                            this.Controls.Add(potionHeal);
                        if (NumItem == 2)
                            this.Controls.Add(potionXP);
                        if (NumItem == 3)
                            this.Controls.Add(potionBoost);
                    }
                    Generate = Rand.Next(0, 2);
                    NumItem = Rand.Next(1, 3);
                    if (Generate == 1)
                    {
                        GeX = Rand.Next(167, 1622);
                        GeY = Rand.Next(131, 649);
                        sword1.Location = new Point(GeX, GeY);
                        sword2.Location = new Point(GeX, GeY);
                        sword3.Location = new Point(GeX, GeY);
                        if (NumItem == 1)
                            this.Controls.Add(sword1);
                        if (NumItem == 2)
                            this.Controls.Add(sword2);
                        if (NumItem == 3)
                            this.Controls.Add(sword3);
                    }
                    Generate = Rand.Next(0, 2);
                    NumItem = Rand.Next(1, 3);
                    if (Generate == 1)
                    {
                        GeX = Rand.Next(167, 1622);
                        GeY = Rand.Next(131, 649);
                        fireball1.Location = new Point(GeX, GeY);
                        fireball2.Location = new Point(GeX, GeY);
                        fireball3.Location = new Point(GeX, GeY);
                        if (NumItem == 1)
                            this.Controls.Add(fireball1);
                        if (NumItem == 2)
                    ...
                    if (Generate == 1)
                    {
                        for (int i = 0; i < NumItem; i++)
                        {
                            GeX = Rand.Next(167, 1622);
                            GeY = Rand.Next(131, 649);
                            Rat.Location = new Point(GeX, GeY);
                    ...
                    if (Generate == 1)
                    {
                        for (int i = 0; i < NumItem; i++)
                        {
                            GeX = Rand.Next(167, 1622);
                            GeY = Rand.Next(131, 649);
                            Enemy.Location = new Point(GeX, GeY);
                    ...
                    if (Generate == 1)
                    {
                        for (int i = 0; i < NumItem; i++)
                        {
                            GeX = Rand.Next(167, 1622);
                            GeY = Rand.Next(131, 649);
                            Wither.Location = new Point(GeX, GeY);
                            this.Controls.Add(Wither);
                        }
                    }
                    Generate = Rand.Next(0, 2);
                    NumItem = Rand.Next(1, 3);
                    if (Generate == 1)
                    {
                        for (int i = 0; i < NumItem; i++)
                        {
                            GeX = Rand.Next(167, 1622);
                            GeY = Rand.Next(131, 649);
                            enemyKing.Location = new Point(GeX, GeY);
                            this.Controls.Add(enemyKing);
                        }
                    }
                    Generate = Rand.Next(0, 2);
                    NumItem = Rand.Next(1, 5);
                    if (Generate == 1)
                    {
                        for (int i = 0; i < NumItem; i++)
                        {
                            GeX = Rand.Next(167, 1622);
                            GeY = Rand.Next(131, 649);
                            chest.Location = new Point(GeX, GeY);
                    ...
                    if (Generate == 1)
                    {
                        for (int i = 0; i < NumItem; i++)
                        {
                            GeX = Rand.Next(167, 1622);
                            GeY = Rand.Next(131, 649);
                            chestGold.Location = new Point(GeX, GeY);
                            this.Controls.Add(chestGold);
                        }
                    }
                    Generate = Rand.Next(0, 2);
                    NumItem = Rand.Next(1, 11);
                    if (Generate == 1)
                    {
                        for (int i = 0; i < NumItem; i++)
                        {
                            GeX = Rand.Next(167, 1622);
                            GeY = Rand.Next(131, 649);
                            coin.Location = new Point(GeX, GeY);
                            this.Controls.Add(coin);
                        }
                    }
                    Generate = Rand.Next(0, 2);
                    NumItem = Rand.Next(1, 4);
                    if (Generate == 1)
                    {
                        for (int i = 0; i < NumItem; i++)
                        {
                            GeX = Rand.Next(167, 1622);
                            GeY = Rand.Next(131, 649);
                            skeleton.Location = new Point(GeX, GeY);
                    ...
                    if (Generate == 1)
                    {
                        for (int i = 0; i < NumItem; i++)
                        {
                            GeX = Rand.Next(167, 1622);
                            GeY = Rand.Next(131, 649);
                            barrel.Location = new Point(GeX, GeY);
                    ...
                    if (Generate == 1)
                    {
                        for (int i = 0; i < NumItem; i++)
                        {
                            GeX = Rand.Next(167, 1622);
                            GeY = Rand.Next(131, 649);
                            Trader.Location = new Point(GeX, GeY);
                            this.Controls.Add(Trader);
                        }
                    }
                    armor1.BringToFront();
                    armor2.BringToFront();
                    ...
                    sword2.BringToFront();
                    sword3.BringToFront();
                    fireball1.BringToFront();
                    fireball2.BringToFront();
                    fireball3.BringToFront();
                    potionHeal.BringToFront();
                    potionXP.BringToFront();
                    potionBoost.BringToFront();
                    Rat.BringToFront();
                    Enemy.BringToFront();
                    Wither.BringToFront();
                    enemyKing.BringToFront();
                    skeleton.BringToFront();
                    coin.BringToFront();
                    barrel.BringToFront();
                    torch.BringToFront();
                    chest.BringToFront();
                    chestGold.BringToFront();
                    Trader.BringToFront();
                    player.BringToFront();
                }
